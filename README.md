# tiny\_paginate
  [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Gem Version](https://badge.fury.io/rb/tiny_paginate.svg?icon=si%3Arubygems)](https://badge.fury.io/rb/tiny_paginate)
